...
func RegisterCommands(app *cobra.Command, c *client.Client) {
	...
	command = &cobra.Command{
		Use:   "show",
		Short: `Get messages by Room ID`,
	}
	tmp1 := new(ShowMessageCommand)
	sub = &cobra.Command{
		Use:   `message ["/messages/ROOMID"]`,
		Short: ``,
...
func (cmd *ShowMessageCommand) Run(c *client.Client, args []string) error {
	...
	if len(args) > 0 {
		...
		path = fmt.Sprintf("/messages/%v", cmd.RoomID)
	}
...
func (cmd *ShowMessageCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var roomID int
	cc.Flags().IntVar(&cmd.RoomID, "roomId", roomID, `Room ID`)
}
